import { clearBoard } from "@/state/features/featureSlice";
import { useAppDispatch } from "@/state/hooks";
import Form from "next/form";

export default function ClearBoardForm({ onClose }: { onClose: () => void }) {
    ...
    return (
        <Form action={removeBoardAction} className="flex flex-col gap-2 items-center">
            <h2 className="text-lg mb-2">Are you sure you want to clear the board?</h2>
